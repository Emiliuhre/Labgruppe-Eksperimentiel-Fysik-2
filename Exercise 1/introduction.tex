...
This report will investigate the reflection and refraction of a beam of light at the surface of a semicircular glass prism. 
This includes using Snell's law to determine the index of refraction of this prism, and investigating the validity of the Fresnel Relations for the same prism.
    \section{Snell's law}
