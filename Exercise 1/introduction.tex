...
This will be achived by using the laws of reflection and refraction also known as Snell's law and the four Fresnel Relations.
    \section{Snell's law}
        Snell's law descripe the relation between angels of incidence and refraction for light passing through different isotripic media. The law is given by
        \begin{align*}
    ...
    \section{The Fresnel Relations}
        ...
        \]
        From these relations we can derive the intensities of the reflected and refracted light in which we can messure.
        \begin{align*}
