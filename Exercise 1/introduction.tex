...
This will be achived by using Snell's law to determine the index of refraction of a material, and then use this to attempt to prove the Fresnel Relations.
    \section{Snell's law}
        ...
        \end{align*}
        With refractive index $n_{\textup{1}}$ for the first media and angle of incidence $\theta_i$. And for the refracted light in the second media $n_{\textup{2}}$ and $\theta_t$
