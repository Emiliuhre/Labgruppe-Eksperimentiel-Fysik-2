...
There was also the issue that a significant portion of the light disappeared somewhere, so that we could not calculate the reflection and transmission coeffitients using $V_0$. We are unsure as to why this is, but maybe the glass that we used absorbed alot of the light.
