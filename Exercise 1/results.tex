...
If we attempt to include a primitive model of how this uncertainty increases with angle, using $\sigma_\theta = 0.25 + \frac{\theta_1}{\max(\theta_1)}$, we instead get figure \ref{fig:new_weighted_average}.
   \begin{figure}[h]
