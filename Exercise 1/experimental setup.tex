...
%
   \begin{figure}[h]
        \includegraphics[width=0.95\textwidth]{figures/EkspFys2_Ex1_setup_drawing_GlassToAir.png}
        \centering
    ...
    \begin{figure}[h]
        \includegraphics[width=0.95\textwidth]{figures/EkspFys2_Ex1_setup_drawing_AirToGlass.png}
        \centering
...
%
\begin{figure}[h]
        \includegraphics[width=0.95\textwidth]{figures/LaserSetup.png}
        \centering
...
%    
    \begin{figure}[h]
        \includegraphics[width=0.95\textwidth]{figures/SensorSetup.png}
        \centering
