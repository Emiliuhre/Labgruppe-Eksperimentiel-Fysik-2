...
\section*{Propagation of Uncertainty for Refractive Index $n$}
    ...
    \[
        \sigma_n = \sqrt{ \left( \pdv{n}{\theta_i} \right)^2 \sigma_{\theta_i}^2 + \left( \pdv{n}{\theta_t} \right)^2 \sigma_{\theta_t}^2 }
    \]
    ...
    \begin{itemize}
        ...
        \[
            \pdv{n}{\theta_i} = \frac{\cos \theta_i}{\sin \theta_t}
        \]
        
        \item \textbf{With respect to $\theta_r$:}
        \[
            \pdv{n}{\theta_t} = -\frac{\sin \theta_i \cos \theta_t}{\sin^2 \theta_r}
        \]
    \end{itemize}
