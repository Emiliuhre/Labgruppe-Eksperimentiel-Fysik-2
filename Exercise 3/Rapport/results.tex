...
The difference between the whole number of periods and the fractional can be seen in figure \ref{fig:RefractiveIndex}. Where we achieve the following TABEL from the weighted means of 2 assumptions.
\begin{figure*}
    \centering
