...
Let $\mathbf{E}_i = \mathbf{E_0}\cos(\omega t - kx)$ be the incident planewave (where $x$ in this case is just distance traveled, as the wave will change directions).
The first wave without the waveplate moves through two beamsplitters, so at the end screen it will be
\[\mathbf{E}_1 = \sqrt{R T} \mathbf{E_0} \cos(\omega t - kx_1)\]
