...
\begin{figure}
    ...
    \caption{\textbf{Phase Retardance}:
        $E_f \rightarrow E_f$,
...
The first wave without the waveplate moves through two beamsplitters, so at the end screen it will be
\[\mathbf{E}_1 = \sqrt{R T}\; \mathbf{E}_0 \cos(\omega t - kx_1)\]
where $x_1$ is the distance travelled by the first 
