\chapter{Conclusion}
%
The index of refraction of air was measured to be $n = 1.000214 \pm 5.4 \cdot 10^{-6}$. 
...
An analysis of the uncertainty suggests that a deviation in the starting gauge pressure of approximately $0.1$ to $0.14 \text{ bar}$, which is well within the range of human visual error during a dynamic pressure drop,
would account for the difference, bringing the results into alignment with expected values.
...
we were able to isolate the maximum intensities and fit the data to the model $I \propto 1 + |\cos(2\theta)|$, which yielded great agreement with data. 